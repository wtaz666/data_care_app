...
class ExperienceDToD extends Component {
    constructor(props) {
        super(props);
        this.state = {
            value1: null,
    ...
    render() {
        const { tabs, tabs2, normSele, normInd, newNormInd, curKpiName, modal1, tableColumns, tableData, clickTab, newTitle } = this.state;
